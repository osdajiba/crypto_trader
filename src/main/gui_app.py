...
class TradingSystemGUI:
    ...
    def save_config(self):
        ...
        try:
            ...
            self.setup_status_var.set("Saving configuration...")
    ...
    def _init_autosave(self):
        ...
        self.autosave_interval = self.config.get("system", "autosave_interval", default=300)  # 5 minutes default
    ...
    def _perform_autosave(self, silent=False):
