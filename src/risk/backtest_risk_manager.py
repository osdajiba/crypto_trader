...
from src.risk.risk_manager import BaseRiskManager, RiskValidationError


class BacktestRiskManager(BaseRiskManager):
    """
    Enhanced backtesting-specific risk management implementation
    
    Provides backtesting-appropriate risk controls and signal validation
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        self.logger.info("BacktestRiskManager initialized")
    ...
    async def initialize(self) -> None:
        ...
        self.logger.info(f"BacktestRiskManager initialized with {initial_capital} initial capital")
        ...
        try:
            ...
            for idx, signal in valid_signals.iterrows():
                ...
                if action not in ['buy', 'sell']:
                    self.logger.warning(f"Unknown action type: {action}, skipping")
