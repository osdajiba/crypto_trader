...
class LocalSource(DataSource):
    ...
    async def fetch_historical(self, symbol: str, timeframe: str, 
        ...
        """
        Fetch historical data with automatic integrity validation and fixing
        ...
        Args:
            ...
            auto_fix: Whether to automatically fix and save detected issues
            
        Returns:
            pd.DataFrame: Historical data (fixed if issues were found)
        """
        logger.info(f"Fetching historical data from source: {symbol} {timeframe}")
